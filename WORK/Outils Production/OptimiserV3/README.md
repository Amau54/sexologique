...
### Construire le site sans "hashing" des noms de fichiers

Cette commande fait la même chose que `build`, mais **sans ajouter de hash** aux noms des fichiers (`style.css` au lieu de `style.a1b2c3d4.css`). C'est utile pour les environnements de test ou les déploiements où les noms de fichiers doivent rester stables.
